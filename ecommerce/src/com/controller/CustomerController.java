    ...
    public static void main(String[] args, int customerId) throws SQLException {
		...
		while (true) {
			...
			case 3:
					...
					//productService.isCategoryExists(category_id); // to check if the category exists
			...
			case 9:
				try {
				    ...
				    if (product!= null) {
				        double totalPrice = productService.calculateTotalPrice(cart1.getProduct_id(), cart1.getQuantity());
